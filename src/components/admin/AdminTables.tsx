        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 font-medium">
              Aşağıdaki listede aktif araç eşleşmeleri ve boş QR stokları yer almaktadır.
            </p>
          </div>
        </div>
            ...
            <button
              ...
              className={`px-3.5 py-2 rounded-xl text-xs font-bold transition-colors cursor-pointer ${
                filterStatus === st
                  ...
                  : 'text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white bg-[#F8F9FA] dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700'
              }`}
            >
        ...
        <table className="w-full text-left text-xs text-zinc-700 dark:text-zinc-300">
          ...
          <tbody className="divide-y divide-zinc-200/80 dark:divide-zinc-800">
            {filteredQRs.length === 0 ? (
              <tr>
                <td colSpan={7} className="p-8 text-center text-zinc-400 dark:text-zinc-500 font-medium">
                  Kayıt bulunamadı.
                </td>
              </tr>
            ) : (
                  ...
                  <tr key={q.id} className="hover:bg-zinc-50/80 dark:hover:bg-zinc-800/50 transition-colors">
                    ...
                    <td className="p-3.5 text-right space-x-2 whitespace-nowrap">
                      <button
                        ...
                        className="p-2 rounded-xl bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-200 transition-colors inline-flex items-center gap-1 text-[11px] font-bold cursor-pointer"
                      ...
                      <button
                        ...
                        className="px-2.5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white transition-colors inline-flex items-center gap-1 text-[11px] font-bold cursor-pointer shadow-xs"
                        title="1024x1024 Yüksek Çözünürlüklü Kare PNG QR İndir"
                      ...
                      <button
                        ...
                        className="p-2 rounded-xl bg-red-50 dark:bg-red-950/60 hover:bg-red-100 dark:hover:bg-red-900/60 text-red-600 dark:text-red-400 transition-colors inline-flex items-center gap-1 text-[11px] font-bold cursor-pointer border border-red-200 dark:border-red-800"
                        title="QR Kodu Sil"
                      >
